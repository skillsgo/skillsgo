...
`SKILLSGO_REGISTRY_STORAGE_GCP_BUCKET` should be set to the name of the bucket you wish to use. It should be something like `fancy-pony-339288.appspot.com`.
...
This path to this file must be set in the environment variable `SKILLSGO_REGISTRY_STORAGE_GCP_SA`.

## Athens Configuration

In order to tell Proxy to use GCP storage set `SKILLSGO_REGISTRY_STORAGE_TYPE` to `gcp`.
