...
func (u *UploadTests) SetupTest() {
	envy.Set("SKILLSGO_REGISTRY_TIMEOUT", "1")
}

func (u *UploadTests) TearDownTest() {
	envy.Set("SKILLSGO_REGISTRY_TIMEOUT", "300")
}
...
func (u *UploadTests) TestUploadTimeout() {
	...
	r.Contains(err.Error(), "uploading mx.1.1.1.manifest failed: context deadline exceeded")
}
