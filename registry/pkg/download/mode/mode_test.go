...
var testCases = []struct {
	...
	},
	{
		...
		input:        "github.com/skillsgo/skillsgo/registry",
		expectedMode: Redirect,
	...
	},
	{
		...
		input:        "github.com/skillsgo/skillsgo/registry/pkg/mode",
		expectedMode: None,
	},
	{
...
func TestNewFile_err(t *testing.T) {
	...
	for _, c := range tc {
		t.Run(c.name, func(subT *testing.T) {
			_, err := NewFile(c.mode, "github.com/skillsgo/skillsgo/registry")
