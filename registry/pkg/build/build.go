...
// `go build -ldflags "-X github.com/skillsgo/skillsgo/registry/pkg/build.version=$(git describe --tags) -X github.com/skillsgo/skillsgo/registry/pkg/build.buildDate=$(date -u +%Y-%m-%d-%H:%M:%S-%Z)"`
package build
