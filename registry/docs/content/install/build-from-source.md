...
go build -ldflags "-X github.com/skillsgo/skillsgo/registry/pkg/build.version=$version -X github.com/skillsgo/skillsgo/registry/pkg/build.buildDate=$date" -o athens ./cmd/proxy
```
