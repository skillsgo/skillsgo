/*
 * [INPUT]: Depends on localized browser collections, static server functions, the content source, and Fumadocs layouts.
 * [OUTPUT]: Provides prerenderable documentation pages for every locale and content slug.
 * [POS]: Serves as the primary localized content loading and MDX rendering boundary for docs-site.
