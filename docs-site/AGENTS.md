# Documentation Site
> F1/F2 Workspace Map | Parent: `/AGENTS.md` | Workspace: `@skillsgo/docs-site`
...
- TanStack Start SPA prerendering emits a static site suitable for CDN hosting.
...
This workspace publishes user-facing SkillsGo documentation. It may explain the App, CLI, and Hub, but it does not own their domain models or replace canonical ADRs, context maps, or reference standards under `/docs`.
