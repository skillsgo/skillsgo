...
- `app/`: four-target desktop startup smoke coverage plus complete macOS journeys spanning the real Flutter App, released CLI process, disposable Hub, and isolated Agent/project state.
