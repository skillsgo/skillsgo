...
func TestJ47WhyAndVerifyRepositoryInstallation(t *testing.T) {
	...
	why := execCLI(t, ctx, container, "why", testSkillName, "--project", scenarioContainerPath(t, "project"), "--output", "json")
	...
	verified := execCLI(t, ctx, container, "verify", "--project", scenarioContainerPath(t, "project"), "--output", "json")
