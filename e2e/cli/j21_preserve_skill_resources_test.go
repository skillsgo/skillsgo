 ...
 * [OUTPUT]: Provides black-box coverage that Hub, Scope Module Store, and Agent Projection preserve nested Skill resources.
...
func TestJ21PreserveSkillResources(t *testing.T) {
	...
	result := execCLI(t, ctx, container, "add", testModulePath+"@v1.3.0", "--skill", testResourcefulSkillName, "--agent", "codex", "--yes", "--output", "json")
	...
	storeFile := containerPathOnHost(t, sandboxRoot, installed.ModuleDir, "skills", "resourceful", relative)
