 ...
 * [OUTPUT]: Provides black-box coverage that Hub, Scope Package Store, and Agent Projection preserve nested Skill resources.
...
func TestJ21PreserveSkillResources(t *testing.T) {
	...
	result := execCLI(t, ctx, container, "add", testPackagePath+"@v1.3.0", "--skill", testResourcefulSkillName, "--agent", "codex", "--yes", "--output", "json")
