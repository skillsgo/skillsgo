...
func TestJ41SkipChangedSkillWithoutLosingData(t *testing.T) {
	...
	writeSkillsShUserLock(t, sandboxRoot, map[string]any{
		"changed": skillsShLockRecord("skills/changed/SKILL.md"),
		"stable":  skillsShLockRecord("skills/stable/SKILL.md"),
	})
	...
	require.Equal(t, "github.com/acme/skills/-/skills/stable", stableResult.SkillID)
