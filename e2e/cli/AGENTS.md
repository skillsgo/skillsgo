...
- `entrypoint.sh`: initializes the mounted suite sandbox and Git baseline, then keeps the reusable runtime container available for Journey-scoped Hub processes.
