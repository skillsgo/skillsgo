/*
 * [INPUT]: Depends on the disposable E2E environment and public Hub exact Module Info and Module Version Skill contracts.
...
func TestJ25ModuleVersionSkillIdentityAndContent(t *testing.T) {
	...
	endpoint := "http://127.0.0.1:3000/api/v1/" + testModulePath + "/versions/" + installed.Version + "/skills?path=skills/alpha"
