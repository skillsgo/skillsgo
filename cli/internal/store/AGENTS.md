...
- `store_test.go`: specifies immutable/idempotent Hub, Local, and captured storage, full source/content/filesystem-state identity, export, risk-only assessment refresh, local-tamper and content-digest rejection, archive and Skill ID traversal defense, and exact retrieval.
