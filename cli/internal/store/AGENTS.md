...
- `store.go`: validates immutable artifact identity and extracted content on read, confines entries beneath the Store root, extracts archives safely, persists Manifest-defined names in provenance-aware receipts, and refreshes risk assessment metadata without changing content or provenance.
