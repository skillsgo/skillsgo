...
- `git_artifact.go`: uses go-git v6 with forced dumb HTTP to read one exact parentless tag from CDN-hosted static repository files and restores validated Package entries without invoking system Git.
