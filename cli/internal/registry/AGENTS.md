...
- `client.go`: resolves exact content matches and assessed Info, downloads Manifest/ZIP responses, and exposes typed HTTP failures from a configured SkillsGo Registry.
