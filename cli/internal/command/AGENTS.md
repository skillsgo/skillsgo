...
- `list.go`: owns the sole installed-Skill listing command, supplies the read-through Package Provider for exact metadata cache reconstruction, and adapts Package-managed/external inventory v8 into stable JSON plus path-rich Human output.
