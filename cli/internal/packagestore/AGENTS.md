...
- `projection_link_unix.go`: creates relative symbolic-link Projections on macOS and Linux.
- `projection_link_windows.go`: creates unprivileged absolute directory-junction Projections on Windows.
