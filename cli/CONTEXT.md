...
The `~/.skillsgo` directory that owns user-scope `skillsgo.yaml`, `skillsgo-lock.yaml`, and `vendor`. Agent-specific directories remain derived Repository Projections rather than SkillsGo state roots.
