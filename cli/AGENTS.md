...
| `internal/hub/` | Client for add-time product-API Repository resolution followed by exact Repository version metadata/ZIP resources, typed membership, bounded download, and Repository h1 verification. |
