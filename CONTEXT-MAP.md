...
- **CLI → Agent targets**: vendors verified Module Versions within user or Workspace scope and generates deterministic per-Agent Module Projections that expose only selected Skills.
