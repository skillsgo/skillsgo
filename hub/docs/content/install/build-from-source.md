...
go build -ldflags "-X github.com/skillsgo/skillsgo/hub/pkg/build.version=$version -X github.com/skillsgo/skillsgo/hub/pkg/build.buildDate=$date" -o athens ./cmd/proxy
```
