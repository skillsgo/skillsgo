...
```HTTP
GET $HOST:$PORT/mod/github.com/acidburn/htp/@v/list
```
...
```HTTP
GET $HOST:$PORT/mod/github.com/acidburn/htp/@v/v1.0.0.info
```
...
```HTTP
GET $HOST:$PORT/mod/github.com/acidburn/htp/@v/v1.0.0.mod
```
...
```HTTP
GET $HOST:$PORT/mod/github.com/acidburn/htp/@v/v1.0.0.zip
```
...
```HTTP
GET $HOST:$PORT/mod/github.com/acidburn/htp/@latest
```
