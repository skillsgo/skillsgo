...
Once this command is done, you'll notice in the  SKILLSGO_HUB_STORAGE folder all modules ready to be moved to your Athens disk storage.
...
>If you set up Athens with the `$SKILLSGO_HUB_DISK_STORAGE_ROOT` environment variable, the root of this storage location is the value of this environment variable. Use `export STORAGE_ROOT=$SKILLSGO_HUB_DISK_STORAGE_ROOT` to prepare your environment for the below commands.
