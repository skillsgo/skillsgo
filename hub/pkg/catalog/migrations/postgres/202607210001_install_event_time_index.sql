-- [INPUT]: Depends on PostgreSQL skill_install_events retained by the initial Catalog schema.
-- [OUTPUT]: Provides the time-window index used by rolling Hot ranking aggregation.
-- [POS]: Serves as the PostgreSQL query-support migration for short-term installation velocity.
