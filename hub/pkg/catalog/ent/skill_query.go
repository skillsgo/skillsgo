...
func (_q *SkillQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *SkillQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *SkillQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *SkillQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *SkillQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *SkillQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SkillQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(skill.Table, skill.Columns, sqlgraph.NewFieldSpec(skill.FieldID, field.TypeInt64))
	_spec.From = _q.sql
