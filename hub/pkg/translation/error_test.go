/*
 * [INPUT]: Depends on OpenAI-compatible HTTP error status semantics and translation permanent-error markers.
 * [OUTPUT]: Specifies retryable timeout/rate/server failures and terminal invalid-request/authentication failures.
