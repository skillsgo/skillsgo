...
- `circuit.go`: provide a process-shared payment-failure admission circuit that prevents queued translation work from repeatedly calling an unfunded provider.
