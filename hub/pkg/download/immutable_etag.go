 ...
 * [OUTPUT]: Provides stable strong ETags and short-circuits matching immutable GET requests with 304.
 * [POS]: Serves as the conditional-delivery helper for exact immutable Package Info responses.
