...
// will most likely carry a Package and a Version inside of them. Furthermore,
...
// pass to it. Values such as the error Kind, Package, Version, Error Message,
...
// or "Give me all errors where caused by a particular Package"
package errors
