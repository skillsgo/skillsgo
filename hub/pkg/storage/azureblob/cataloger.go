 ...
 * [OUTPUT]: Provides the azureblob package behavior implemented by cataloger.go.
...
func parsModVer(p string) (paths.AllPathParams, error) {
	...
	// github.com/gomods/testCatalogPackage/@v/v1.2.0976.info
	m, v := config.PackageVersionFromPath(p)
