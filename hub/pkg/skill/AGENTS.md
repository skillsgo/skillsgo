...
- `git_fetcher.go`, `git_helpers.go`, `repository_cache_test.go`: resolve Git revisions, enforce public-host/redirect/disk boundaries, and share repository caches safely across root and nested Skills.
