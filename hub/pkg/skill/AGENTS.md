...
- `zip_compression.go`: adapts full Git tar streams into the shared bounded Package Artifact tree contract without constructing ZIPs, preserving safe Package-contained symlinks and omitting unsafe links.
