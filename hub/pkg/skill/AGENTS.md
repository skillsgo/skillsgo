...
- `zip_compression.go`: adapts full Git archives into the shared bounded deterministic Module Artifact contract, preserving safe Module-contained symlinks and omitting unsafe links.
