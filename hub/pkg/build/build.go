/*
 * [INPUT]: Depends on the build package imports and contracts declared in this file.
 * [OUTPUT]: Provides the build package behavior implemented by build.go.
 * [POS]: Serves as maintained source in the build package in its renamed SkillsGo Hub or CLI workspace.
...
// `go build -ldflags "-X github.com/skillsgo/skillsgo/hub/pkg/build.version=$(git describe --tags) -X github.com/skillsgo/skillsgo/hub/pkg/build.buildDate=$(date -u +%Y-%m-%d-%H:%M:%S-%Z)"`
package build
