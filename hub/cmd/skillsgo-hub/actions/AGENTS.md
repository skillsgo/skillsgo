...
- `catalog_protocol.go`, `catalog_protocol_test.go`: retain the pre-publication metadata projection seam while proving that nested Skills are not independently downloadable artifact resources.
