...
- `package_publisher.go`: validates one complete Package Artifact, computes description and document digests, prepares typed immutable Package Info plus content-addressed Skill source objects, and coordinates bounded and negative-cached Source Repository work.
