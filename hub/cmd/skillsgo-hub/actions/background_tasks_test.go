 ...
 * [OUTPUT]: Specifies stable business-task kinds and bounded translation timeout behavior.
...
func TestTranslationBatchesUseBoundedTimeouts(t *testing.T) {
	require.Equal(t, 2*time.Minute, descriptionTranslationBatchArgs{}.JobTimeout())
	require.Equal(t, 2*time.Minute, documentTranslationArgs{}.JobTimeout())
}
