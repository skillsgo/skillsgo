// [INPUT]: Depends on the Go toolchain plus Hub HTTP, PostgreSQL/pgx, sqlc generation, Atlas migrations, River, storage, source-resolution, telemetry, and Testcontainers libraries.
...
require (
	...
	github.com/skillsgo/skillsgo/protocol v0.0.0-20260809095001-2ce42acd5f6f
