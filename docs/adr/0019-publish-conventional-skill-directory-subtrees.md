...
- Package and Scope trees contain published Skill subtrees, the optional authored root README, and applicable plugin manifests rather than complete Source Repository snapshots.
