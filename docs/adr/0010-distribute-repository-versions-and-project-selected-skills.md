...
ADR-0019 supersedes this decision's complete Source Repository tree and Package-relative cross-member resource assumptions. A Package Version now contains the minimal union of conventionally discovered self-contained Skill directory subtrees while remaining the version, Sum, lock, and Store unit.
