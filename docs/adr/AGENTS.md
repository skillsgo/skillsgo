...
- `0013-require-user-reviewed-external-skill-adoption.md`: makes External Skill adoption a user-reviewed Hub candidate and immutable-version selection, separates descriptive local source evidence from Hub candidates, permits multiple versions of one Repository per scope, and requires 30-day per-Skill recovery.
