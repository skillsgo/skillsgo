...
<details>
  <summary><strong>Svenska</strong> · Språk</summary>
  <br>
  <p>
...
> [!IMPORTANT]
> SkillsGo utvecklas aktivt inför den första stabila versionen. Offentliga protokoll, beständiga format och installationsbeteende kan komma att ändras.
