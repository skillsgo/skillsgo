...
<details>
  <summary><strong>Bahasa Indonesia</strong> · Bahasa</summary>
  <br>
  <p>
...
> [!IMPORTANT]
> SkillsGo masih dikembangkan secara aktif sebelum rilis stabil pertamanya. Protokol publik, format persisten, dan perilaku instalasi dapat berubah.
