...
<details>
  <summary><strong>Русский</strong> · Языки</summary>
  <br>
  <p>
...
> [!IMPORTANT]
> SkillsGo активно развивается и пока находится на стадии предварительного выпуска. До первой стабильной версии публичные протоколы, форматы постоянного хранения и поведение установки могут измениться.
