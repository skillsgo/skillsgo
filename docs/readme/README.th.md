...
<details>
  <summary><strong>ไทย</strong> · ภาษา</summary>
  <br>
  <p>
...
> [!IMPORTANT]
> SkillsGo ยังอยู่ระหว่างการพัฒนาอย่างต่อเนื่องก่อนรุ่นเสถียรรุ่นแรก โปรโตคอลสาธารณะ รูปแบบข้อมูลถาวร และพฤติกรรมการติดตั้งอาจเปลี่ยนแปลงได้
