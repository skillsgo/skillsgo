<p align="center">
  <img src="../../assets/readme/hero.zh-HK.svg" width="100%" alt="SkillsGo——探索、驗證及管理 Agent Skills">
</p>
...
<p align="center">
  <img src="../../assets/readme/hub-registry.zh-HK.svg" width="100%" alt="原始碼儲存庫經 SkillsGo Hub 轉化成一致的 App、CLI 與 Coding Agent 安裝">
</p>
...
- **上下文足跡洞察** — 估算常駐 Skill 名稱與描述佔用的字元量，再找出過去 45 或 90 日內未偵測到呼叫的 Skill。這是本機上下文的近似指標，而不是模型計費資料。
- **兩種產品介面，一套協定** — 使用 App 完成互動式工作流程，使用 CLI 實現自動化；兩者都遵循同一套 Hub 協定。

## 查看 App 的實際應用

桌面 App 把探索、來源證據、安裝目標與本機清單串連成直覺易用的流程。個人使用毋須登入。

<p align="center">
  <img src="../../assets/readme/discover-live-online.png" width="100%" alt="SkillsGo 桌面 App 連接網上 Hub 並顯示即時 Agent Skills">
</p>
...
**專案範圍管理 —** 將同一份清單收窄至單一專案，即可排除全域雜訊，檢視其安裝項目、使用證據與未受管理的 Skill。
...
<p align="center">
  <img src="../../assets/readme/workflow.zh-HK.svg" width="100%" alt="SkillsGo 工作流程：探索、檢查、選擇目標、安裝及管理">
</p>
...
4. CLI 根據清單與鎖定檔產生受保護的本機 Package 樹及 Agent 安裝映射。
