...
<details>
  <summary><strong>Polski</strong> · Języki</summary>
  <br>
  <p>
...
> [!IMPORTANT]
> SkillsGo jest aktywnie rozwijany przed pierwszym stabilnym wydaniem. Publiczne protokoły, trwałe formaty i sposób instalacji mogą się zmienić.
