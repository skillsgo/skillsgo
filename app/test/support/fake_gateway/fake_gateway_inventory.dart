 ...
 * [OUTPUT]: Provides installed inventory with usage-load capture, local detail, persisted update-check cache, and controllable update-state inspection behavior.
...
mixin FakeGatewayInventory on FakeSkillsGatewayCore {
  ...
  Future<List<InstalledSkill>> listInstalled({
    ...
    if (includeUsage) usageLoads++;
    return libraryError != null
        ? throw libraryError!
