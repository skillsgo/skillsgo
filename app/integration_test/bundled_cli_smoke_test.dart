/*
 * [INPUT]: Depends on the production desktop bundle, RealSkillsGateway startup handshake, and rendered SkillsGo App root.
...
void main() {
  ...
  testWidgets('starts with the platform-bundled CLI', (tester) async {
    final gateway = RealSkillsGateway(allowDeveloperCliOverride: false);
