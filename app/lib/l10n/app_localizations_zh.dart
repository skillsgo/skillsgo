...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get privacySettingsOpenFailed => '未能打开系统设置，请手动打开后重试。';
  ...
  @override
  String get libraryNeedsAttention => '需要处理';

  @override
  String get libraryBudgetInsights => '常驻技能预算概览';

  @override
  String get libraryResidentBudget => '上下文常驻';

  @override
  String get libraryResidentBudgetTooltip =>
      '当前范围内 Skill 名称与描述的字符数；搜索、状态筛选和排序不影响此数值。';

  @override
  String get libraryUnusedBudget45Days => '闲置占用';

  @override
  String get libraryUnusedBudget45DaysTooltip =>
      '统计可用且最近 45 天零调用的 Skills 所占字符数与比例；点击可筛选，≥ 表示部分使用统计不可用。';

  @override
  String get libraryBudgetUnknown => '暂不可判断';

  @override
  String get libraryBudgetCharacters => '字符';

  @override
  String get libraryFilterEmptyTitle => '没有符合这些筛选条件的 Skills';

  @override
  String get libraryFilterEmptyMessage => '清除或调整管理状态、使用状态条件以查看更多 Skills。';

  @override
  String get libraryUnusedEmptyTitle => '没有未调用的 Skills';

  @override
  String get libraryUnusedEmptyMessage => '所有具有可用统计数据的 Skills 在最近 45 天内都被调用过。';

  @override
  String get libraryOtherEmptyTitle => '没有其他方式安装的 Skills';

  @override
  String get libraryOtherEmptyMessage => '当前上下文中的所有 Skills 均由 SkillsGo 管理。';

  @override
  String get libraryUpdatesEmptyMessage => '当前上下文中没有可用的 Package 更新。';

  @override
  String get libraryUsageUnavailable => '使用统计不可用';

  @override
  String get libraryUsageCalculating => '统计中';

  @override
  String get libraryUsageNotSupported => '暂未支持';

  @override
  String libraryUsageContributionMessage(String agents) {
    return 'SkillsGo 是开源项目，但我们无法安装并测试所有 Coding Agent。你的 Coding Agent 也可以和我们一起完善 $agents 的使用统计支持。';
  }

  @override
  String libraryUsageContributionPrompt(String agents) {
    return 'Hi！想请你帮个忙，一起为开源项目 SkillsGo 完善 $agents 的本地使用统计支持。项目仓库是 https://github.com/skillsgo/skillsgo。开始前可以先读一下根目录的 AGENTS.md，以及我们查看或修改的文件所受约束的每一层 AGENTS.md。cli/internal/skillusage 中已有的采集器可以作为参考；实现时沿用相同的隐私保护型 45/90 天使用统计契约就好，完成后再补充针对性测试并更新相关英文文档。另外也请留意，不要收集或暴露提示词内容、密钥或无关的私人数据。';
  }

  @override
  String get libraryUsageCopyContributionPrompt => '复制提示语';

  @override
  String get libraryUsageContributionPromptCopied => '已复制';

  @override
  String get libraryUsageOpenRepository => '打开 GitHub';
  ...
  @override
  String get librarySortPackageGrouped => '按 Package 分组';
  ...
  @override
  String get libraryUnused45Days => '45 天未调用';

  @override
  String get libraryUnused90Days => '90 天未调用';

  @override
  String get libraryFilterTooltip => '当前范围内的全部已安装 Skills';

  @override
  String get libraryManagementStatus => '管理状态';

  @override
  String get libraryUsageStatus => '使用状态';

  @override
  String get libraryAnyUsage => '不限使用情况';
  ...
  String get libraryFilterUnused45DaysTooltip =>
      '仅显示统计可用且最近 45 天调用次数为 0 的 Skills';

  @override
  String get libraryFilterUnused90DaysTooltip =>
      '仅显示统计可用且最近 90 天调用次数为 0 的 Skills';
  ...
  @override
  String get librarySkillColumn => '技能';

  @override
  String get libraryHits45Days => '45 天调用';

  @override
  String get libraryHits90Days => '90 天调用';

  @override
  String get libraryInstallationColumn => '安装位置';
  ...
  @override
  String get localScanPermissionTitle => '读取这些目录';

  @override
  String get localScanPermissionDescription => '用于识别已安装的 Skill 和使用情况。';

  @override
  String get localScanPrivacySummary => '仅在本机处理，不会上传文件或对话。';

  @override
  String get localScanContinue => '继续';

  @override
  String get localScanDefer => '暂不';

  @override
  String get localScanDeferredTitle => '尚未读取这些项目';

  @override
  String get localScanDeferredMessage => '允许读取后，才能识别其中的 Skill 和使用情况。';

  @override
  String get localScanResume => '继续读取';
...
class AppLocalizationsZhHantHk extends AppLocalizationsZh {
  ...
  @override
  String get privacySettingsOpenFailed => '未能打開系統設定，請手動打開後重試。';
  ...
  @override
  String get libraryNeedsAttention => '需要處理';

  @override
  String get libraryBudgetInsights => '常駐技能預算概覽';

  @override
  String get libraryResidentBudget => '上下文常駐';

  @override
  String get libraryResidentBudgetTooltip =>
      '目前範圍內 Skill 名稱與描述的字元數；搜尋、狀態篩選和排序不影響此數值。';

  @override
  String get libraryUnusedBudget45Days => '閒置佔用';

  @override
  String get libraryUnusedBudget45DaysTooltip =>
      '統計可用且最近 45 天零呼叫的 Skills 所佔字元數與比例；點擊可篩選，≥ 表示部分使用統計無法使用。';

  @override
  String get libraryBudgetUnknown => '暫時無法判斷';

  @override
  String get libraryBudgetCharacters => '字元';

  @override
  String get libraryFilterEmptyTitle => '沒有符合這些篩選條件的 Skills';

  @override
  String get libraryFilterEmptyMessage => '清除或調整管理狀態、使用狀態條件以查看更多 Skills。';

  @override
  String get libraryUnusedEmptyTitle => '沒有未呼叫的 Skills';

  @override
  String get libraryUnusedEmptyMessage => '所有具有可用統計資料的 Skills 在最近 45 天內都被呼叫過。';

  @override
  String get libraryOtherEmptyTitle => '沒有其他方式安裝的 Skills';

  @override
  String get libraryOtherEmptyMessage => '目前情境中的所有 Skills 均由 SkillsGo 管理。';

  @override
  String get libraryUpdatesEmptyMessage => '目前情境中沒有可用的 Package 更新。';

  @override
  String get libraryUsageUnavailable => '使用統計無法使用';

  @override
  String get libraryUsageCalculating => '統計中';
  ...
  @override
  String get librarySortPackageGrouped => '依 Package 分組';
  ...
  @override
  String get libraryUnused45Days => '45 天未呼叫';

  @override
  String get libraryUnused90Days => '90 天未呼叫';

  @override
  String get libraryFilterTooltip => '目前範圍內的全部已安裝 Skills';

  @override
  String get libraryManagementStatus => '管理狀態';

  @override
  String get libraryUsageStatus => '使用狀態';

  @override
  String get libraryAnyUsage => '不限使用情況';
  ...
  @override
  String get libraryFilterUnused45DaysTooltip =>
      '僅顯示統計可用且最近 45 天呼叫次數為 0 的 Skills';

  @override
  String get libraryFilterUnused90DaysTooltip =>
      '僅顯示統計可用且最近 90 天呼叫次數為 0 的 Skills';
  ...
  @override
  String get localScanPermissionTitle => '讀取這些資料夾';

  @override
  String get localScanPermissionDescription => '用於識別已安裝的 Skill 和使用情況。';

  @override
  String get localScanPrivacySummary => '僅在本機處理，不會上傳檔案或對話。';

  @override
  String get localScanContinue => '繼續';

  @override
  String get localScanDefer => '稍後';

  @override
  String get localScanDeferredTitle => '尚未讀取這些項目';

  @override
  String get localScanDeferredMessage => '允許讀取後，才能識別其中的 Skill 和使用情況。';

  @override
  String get localScanResume => '繼續讀取';
...
class AppLocalizationsZhHantTw extends AppLocalizationsZh {
  ...
  @override
  String get privacySettingsOpenFailed => '無法開啟系統設定，請手動開啟後再試一次。';
  ...
  @override
  String get localScanDeferredTitle => '尚未讀取這些專案';
