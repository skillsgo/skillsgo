...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get libraryFilter => 'Фільтр';
  ...
  String get privacySettingsOpenFailed =>
      'Не вдалося відкрити Системні параметри. Відкрийте їх вручну та повторіть спробу.';
  ...
  @override
  String get libraryNeedsAttention => 'Потребує уваги';

  @override
  String get libraryBudgetInsights => 'Огляд бюджету резидентних Skills';

  @override
  String get libraryResidentBudget => 'Резидентний контекст';

  @override
  String get libraryResidentBudgetTooltip =>
      'Кількість символів у назвах і описах Skills поточної області. Пошук, фільтри та сортування не впливають на це значення.';

  @override
  String get libraryUnusedBudget45Days => 'Неактивний обсяг';

  @override
  String get libraryUnusedBudget45DaysTooltip =>
      'Кількість і частка символів, зайнятих Skills із доступними даними використання та без викликів протягом останніх 45 днів. Натисніть для фільтрації; ≥ означає, що частина даних недоступна.';

  @override
  String get libraryBudgetUnknown => 'Недоступно';

  @override
  String get libraryBudgetCharacters => 'символів';

  @override
  String get libraryFilterEmptyTitle =>
      'Жодні Skills не відповідають цим фільтрам';

  @override
  String get libraryFilterEmptyMessage =>
      'Змініть умову керування чи використання, щоб побачити більше Skills.';

  @override
  String get libraryUnusedEmptyTitle => 'Немає невикористовуваних Skills';

  @override
  String get libraryUnusedEmptyMessage =>
      'Кожен Skill із даними використання викликався протягом останніх 45 днів.';

  @override
  String get libraryOtherEmptyTitle => 'Немає інших інсталяцій';

  @override
  String get libraryOtherEmptyMessage =>
      'Кожен Skill у цьому контексті керується SkillsGo.';

  @override
  String get libraryUpdatesEmptyMessage =>
      'У цьому контексті немає оновлень Package.';

  @override
  String get libraryUsageUnavailable => 'Дані використання недоступні';

  @override
  String get libraryUsageCalculating => 'Підрахунок';
  ...
  String libraryUsageCount(int count) {
    return 'Викликів: $count';
  }

  @override
  String get librarySortPackageGrouped => 'Згруповано за Package';

  @override
  String get librarySortDescending => 'За спаданням';

  @override
  String get librarySortAscending => 'За зростанням';
  ...
  @override
  String get libraryUnused45Days => 'Не використовувалися 45 днів';

  @override
  String get libraryUnused90Days => 'Не використовувалися 90 днів';

  @override
  String get libraryFilterTooltip => 'Усі встановлені Skills у цій області';

  @override
  String get libraryManagementStatus => 'Стан керування';

  @override
  String get libraryUsageStatus => 'Стан використання';

  @override
  String get libraryAnyUsage => 'Будь-яке використання';
  ...
  String get libraryFilterUnused45DaysTooltip =>
      'Skills із доступною статистикою та без викликів за останні 45 днів';

  @override
  String get libraryFilterUnused90DaysTooltip =>
      'Skills із доступною статистикою та без викликів за останні 90 днів';
  ...
  @override
  String get localScanPermissionTitle => 'Прочитати ці папки';

  @override
  String get localScanPermissionDescription =>
      'Використовується для визначення встановлених Skill та їх використання.';

  @override
  String get localScanPrivacySummary =>
      'Обробляється лише на цьому пристрої. Файли та розмови ніколи не завантажуються.';

  @override
  String get localScanContinue => 'Продовжити';

  @override
  String get localScanDefer => 'Не зараз';

  @override
  String get localScanDeferredTitle => 'Проєкти ще не прочитано';

  @override
  String get localScanDeferredMessage =>
      'Дозвольте доступ, щоб визначити встановлені Skills та їх використання.';

  @override
  String get localScanResume => 'Продовжити читання';
  ...
  String translatedFrom(String language) {
    return 'Перекладено з мови: $language';
  }
  ...
  String sourceLanguageName(String code) {
    String _temp0 = intl.Intl.selectLogic(code, {
      'en': 'англійська',
      'zhHans': 'китайська (спрощене письмо)',
      'zhHant': 'китайська (традиційне письмо)',
      'ja': 'японська',
      'ko': 'корейська',
      'fr': 'французька',
      'de': 'німецька',
  ...
  @override
  String get showOriginalContent => 'Показати оригінал';

  @override
  String get showTranslation => 'Показати переклад';
  ...
  String installPackageSkills(String packagePath, int count) {
    return 'Встановити всі навички $packagePath ($count)';
  }
  ...
  @override
  String get batchAdoptionAction => 'Керуйте наявними навичками';
  ...
  @override
  String get batchAdoptionChecking => 'Перевірка наявних навичок…';

  @override
  String get batchAdoptionRetry => 'Ще раз перевірте керовані навички';
  ...
  @override
  String get batchAdoptionPending => 'Додавання навичок до управління…';
  ...
  @override
  String get batchAdoptionPainLocation => 'Невідоме місце встановлення';

  @override
  String get batchAdoptionPainFreshness => 'Невідомий статус оновлення';

  @override
  String get batchAdoptionPainRecovery => 'Немає відновлення при поломці';

  @override
  String get batchAdoptionPainVersionDrift => 'Різні версії для проектів';

  @override
  String get batchAdoptionFolderTitle => 'Існуючий Skills';

  @override
  String get batchAdoptionFolderSubtitle => 'Незрозумілий статус';

  @override
  String get batchAdoptionAfterLabel => 'ПІСЛЯ';

  @override
  String get batchAdoptionAfterTitle => 'Одна чітка бібліотека';

  @override
  String get batchAdoptionLibraryTitle => 'Бібліотека SkillsGo';

  @override
  String get batchAdoptionBenefitLocation => 'Очистити локації';

  @override
  String get batchAdoptionBenefitFreshness => 'Оновлення видно';

  @override
  String get batchAdoptionBenefitRecovery => 'Легке відновлення';

  @override
  String get batchAdoptionBenefitVersions => 'Версії зрозумілі';

  @override
  String get batchAdoptionManagedSection => 'Керується SkillsGo';

  @override
  String get batchAdoptionPendingSection => 'В очікуванні';
  ...
  @override
  String get batchAdoptionTransitionLabel => 'ОРГАНІЗУЙТЕ';

  @override
  String get batchAdoptionStatusTitle => 'Статус управління';

  @override
  String get batchAdoptionStatusManaged => 'Керований';

  @override
  String get batchAdoptionStatusProgress => 'Організація';
  ...
  @override
  String get batchAdoptionBoardComplete => 'ВСЕ ЯСНО';

  @override
  String get batchAdoptionBoardPartial => 'ЗАВЕРШЕНО';

  @override
  String get batchAdoptionStatusTotal => 'Всього';

  @override
  String get batchAdoptionQueueComplete => 'Ніякі навички не чекають';
  ...
  @override
  String get batchAdoptionNextLabel => 'ДАЛІ';
  ...
  @override
  String get batchAdoptionSkip => 'Не зараз';

  @override
  String get batchAdoptionConfirm => 'Додати до управління';

  @override
  String get batchAdoptionExecutionRetry => 'Повторіть спробу';

  @override
  String get batchAdoptionResultTitle => 'Skills додано до керування';

  @override
  String batchAdoptionSummary(int adopted, int skipped) {
    return 'Навички $adopted додано до керування, $skipped пропущено.';
  }
  ...
  @override
  String get batchAdoptionClose => 'Закрити';

  @override
  String get installMoreTargets => 'Встановити в інших місцях';

  @override
  String get detailPackageSource => 'Джерело пакета';
