...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get libraryFilter => 'تصفية';
  ...
  String get privacySettingsOpenFailed =>
      'تعذّر فتح إعدادات النظام. افتحها يدويًا ثم حاول مرة أخرى.';
  ...
  @override
  String get libraryNeedsAttention => 'تحتاج إلى الانتباه';

  @override
  String get libraryBudgetInsights => 'نظرة عامة على ميزانية المهارات المقيمة';

  @override
  String get libraryResidentBudget => 'السياق المقيم';

  @override
  String get libraryResidentBudgetTooltip =>
      'عدد أحرف أسماء المهارات وأوصافها في النطاق الحالي. لا يؤثر البحث أو التصفية أو الفرز في هذه القيمة.';

  @override
  String get libraryUnusedBudget45Days => 'المساحة الخاملة';

  @override
  String get libraryUnusedBudget45DaysTooltip =>
      'عدد الأحرف ونسبتها للمهارات ذات بيانات الاستخدام المتاحة ومن دون استدعاءات خلال آخر 45 يومًا. انقر للتصفية؛ تعني ≥ أن بعض بيانات الاستخدام غير متاحة.';

  @override
  String get libraryBudgetUnknown => 'غير متاح';

  @override
  String get libraryBudgetCharacters => 'حرف';

  @override
  String get libraryFilterEmptyTitle =>
      'لا توجد Skills تطابق عوامل التصفية هذه';

  @override
  String get libraryFilterEmptyMessage =>
      'غيّر شرط الإدارة أو الاستخدام لعرض المزيد من Skills.';

  @override
  String get libraryUnusedEmptyTitle => 'لا توجد Skills غير مستخدمة';

  @override
  String get libraryUnusedEmptyMessage =>
      'تم استدعاء كل Skill تتوفر له بيانات استخدام خلال آخر 45 يومًا.';

  @override
  String get libraryOtherEmptyTitle => 'لا توجد عمليات تثبيت أخرى';

  @override
  String get libraryOtherEmptyMessage =>
      'كل Skill في هذا السياق مُدار بواسطة SkillsGo.';

  @override
  String get libraryUpdatesEmptyMessage =>
      'لا تتوفر تحديثات Packages في هذا السياق.';

  @override
  String get libraryUsageUnavailable => 'بيانات الاستخدام غير متاحة';

  @override
  String get libraryUsageCalculating => 'جارٍ الحساب';
  ...
  String libraryUsageCount(int count) {
    return '$count من الاستدعاءات';
  }

  @override
  String get librarySortPackageGrouped => 'مجمّعة حسب Package';

  @override
  String get librarySortDescending => 'تنازلي';

  @override
  String get librarySortAscending => 'تصاعدي';
  ...
  @override
  String get libraryUnused45Days => 'غير مستخدمة منذ 45 يومًا';

  @override
  String get libraryUnused90Days => 'غير مستخدمة منذ 90 يومًا';

  @override
  String get libraryFilterTooltip => 'كل المهارات المثبتة في هذا النطاق';

  @override
  String get libraryManagementStatus => 'حالة الإدارة';

  @override
  String get libraryUsageStatus => 'حالة الاستخدام';

  @override
  String get libraryAnyUsage => 'أي استخدام';
  ...
  String get libraryFilterUnused45DaysTooltip =>
      'المهارات ذات إحصاءات الاستخدام المتاحة والتي لم يتم استدعاؤها خلال آخر 45 يومًا';

  @override
  String get libraryFilterUnused90DaysTooltip =>
      'المهارات ذات إحصاءات الاستخدام المتاحة والتي لم يتم استدعاؤها خلال آخر 90 يومًا';
  ...
  @override
  String get localScanPermissionTitle => 'قراءة هذه المجلدات';

  @override
  String get localScanPermissionDescription =>
      'تُستخدم للتعرّف على Skills المثبتة واستخدامها.';

  @override
  String get localScanPrivacySummary =>
      'تتم المعالجة على هذا الجهاز فقط. لا يتم رفع الملفات أو المحادثات.';

  @override
  String get localScanContinue => 'متابعة';

  @override
  String get localScanDefer => 'ليس الآن';

  @override
  String get localScanDeferredTitle => 'لم تتم قراءة المشاريع بعد';

  @override
  String get localScanDeferredMessage =>
      'اسمح بالوصول للتعرّف على Skills المثبتة واستخدامها.';

  @override
  String get localScanResume => 'متابعة القراءة';
  ...
  String installPackageSkills(String packagePath, int count) {
    return 'تثبيت جميع مهارات ⁨$packagePath⁩ (⁨$count⁩)';
  }
  ...
  @override
  String get batchAdoptionAction => 'إدارة المهارات الموجودة';
  ...
  @override
  String get batchAdoptionChecking => 'التحقق من المهارات الموجودة...';

  @override
  String get batchAdoptionRetry => 'إعادة التحقق من Skills التي يمكن إدارتها';
  ...
  @override
  String get batchAdoptionPending => 'إضافة مهارات إلى الإدارة...';

  @override
  String get batchAdoptionTitle => 'إدارة المهارات الموجودة مع SkillsGo؟';
  ...
  @override
  String get batchAdoptionPainLocation => 'موقع التثبيت غير معروف';

  @override
  String get batchAdoptionPainFreshness => 'حالة التحديث غير معروفة';

  @override
  String get batchAdoptionPainRecovery => 'لا توجد استعادة عند حدوث تلف';

  @override
  String get batchAdoptionPainVersionDrift => 'إصدارات مختلفة عبر المشاريع';

  @override
  String get batchAdoptionFolderTitle => 'Skills موجودة';

  @override
  String get batchAdoptionFolderSubtitle => 'الوضع غير واضح';

  @override
  String get batchAdoptionAfterLabel => 'بعد';

  @override
  String get batchAdoptionAfterTitle => 'مكتبة واحدة واضحة';

  @override
  String get batchAdoptionLibraryTitle => 'مكتبة SkillsGo';

  @override
  String get batchAdoptionBenefitLocation => 'مواقع واضحة';

  @override
  String get batchAdoptionBenefitFreshness => 'التحديثات مرئية';

  @override
  String get batchAdoptionBenefitRecovery => 'استعادة سهلة';

  @override
  String get batchAdoptionBenefitVersions => 'الإصدارات واضحة';

  @override
  String get batchAdoptionManagedSection => 'تحت إدارة SkillsGo';

  @override
  String get batchAdoptionPendingSection => 'في انتظار';
  ...
  @override
  String get batchAdoptionTransitionLabel => 'تنظيم';

  @override
  String get batchAdoptionStatusTitle => 'حالة الإدارة';

  @override
  String get batchAdoptionStatusManaged => 'مُدار';

  @override
  String get batchAdoptionStatusProgress => 'جارٍ التنظيم';

  @override
  String get batchAdoptionStatusSkipped => 'تم تخطيه';
  ...
  @override
  String get batchAdoptionBoardComplete => 'كل شيء واضح';

  @override
  String get batchAdoptionBoardPartial => 'اكتمل جزئيًا';

  @override
  String get batchAdoptionStatusTotal => 'المجموع';

  @override
  String get batchAdoptionQueueComplete => 'لا توجد مهارات في الانتظار';

  @override
  String get batchAdoptionQueueWaiting => 'ستظهر Skills هنا بعد التحقق';

  @override
  String get batchAdoptionNextLabel => 'التالي';
  ...
  @override
  String get batchAdoptionSkip => 'ليس الآن';

  @override
  String get batchAdoptionConfirm => 'إضافة إلى الإدارة';

  @override
  String get batchAdoptionExecutionRetry => 'أعد المحاولة';

  @override
  String get batchAdoptionResultTitle => 'أُضيفت Skills إلى الإدارة';

  @override
  String batchAdoptionSummary(int adopted, int skipped) {
    return 'تمت إضافة مهارات ⁨$adopted⁩ إلى الإدارة، وتم تخطي ⁨$skipped⁩.';
  }
  ...
  @override
  String get batchAdoptionClose => 'إغلاق';

  @override
  String get installMoreTargets => 'تثبيت في المزيد من المواقع';

  @override
  String get detailPackageSource => 'مصدر الحزمة';
