...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get libraryFilter => 'Фильтр';
  ...
  String get privacySettingsOpenFailed =>
      'Не удалось открыть Системные настройки. Откройте их вручную и повторите попытку.';
  ...
  @override
  String get libraryNeedsAttention => 'Требует внимания';

  @override
  String get libraryBudgetInsights => 'Обзор бюджета резидентных Skills';

  @override
  String get libraryResidentBudget => 'Резидентный контекст';

  @override
  String get libraryResidentBudgetTooltip =>
      'Количество символов в названиях и описаниях Skills текущей области. Поиск, фильтры и сортировка не влияют на это значение.';

  @override
  String get libraryUnusedBudget45Days => 'Неактивный объём';

  @override
  String get libraryUnusedBudget45DaysTooltip =>
      'Количество и доля символов, занятых Skills с доступными данными использования и без вызовов за последние 45 дней. Нажмите для фильтрации; ≥ означает, что часть данных недоступна.';

  @override
  String get libraryBudgetUnknown => 'Недоступно';

  @override
  String get libraryBudgetCharacters => 'символов';

  @override
  String get libraryFilterEmptyTitle =>
      'Нет Skills, соответствующих этим фильтрам';

  @override
  String get libraryFilterEmptyMessage =>
      'Измените условие управления или использования, чтобы увидеть больше Skills.';

  @override
  String get libraryUnusedEmptyTitle => 'Нет неиспользуемых Skills';

  @override
  String get libraryUnusedEmptyMessage =>
      'Каждый Skill с доступными данными об использовании вызывался в течение последних 45 дней.';

  @override
  String get libraryOtherEmptyTitle => 'Нет других установок';

  @override
  String get libraryOtherEmptyMessage =>
      'Каждый Skill в этом контексте управляется SkillsGo.';

  @override
  String get libraryUpdatesEmptyMessage =>
      'В этом контексте нет доступных обновлений Package.';

  @override
  String get libraryUsageUnavailable => 'Данные об использовании недоступны';

  @override
  String get libraryUsageCalculating => 'Подсчёт';
  ...
  String libraryUsageCount(int count) {
    return 'Вызовов: $count';
  }

  @override
  String get librarySortPackageGrouped => 'Сгруппировано по Package';

  @override
  String get librarySortDescending => 'По убыванию';

  @override
  String get librarySortAscending => 'По возрастанию';
  ...
  @override
  String get libraryImportedSkills => 'Управляются SkillsGo';

  @override
  String get libraryLocalSkills => 'Установлены другим способом';

  @override
  String get libraryUnused45Days => 'Не использовались 45 дней';

  @override
  String get libraryUnused90Days => 'Не использовались 90 дней';

  @override
  String get libraryFilterTooltip => 'Все установленные Skills в этой области';

  @override
  String get libraryManagementStatus => 'Статус управления';

  @override
  String get libraryUsageStatus => 'Статус использования';

  @override
  String get libraryAnyUsage => 'Любое использование';

  @override
  String get libraryFilterManagedTooltip =>
      'Можно обновлять и удалять через SkillsGo';

  @override
  String get libraryFilterOtherTooltip =>
      'Перед обновлением добавьте их под управление SkillsGo';

  @override
  String get libraryFilterUnused45DaysTooltip =>
      'Skills с доступной статистикой и без вызовов за последние 45 дней';

  @override
  String get libraryFilterUnused90DaysTooltip =>
      'Skills с доступной статистикой и без вызовов за последние 90 дней';

  @override
  String get libraryFilterUpdatesTooltip =>
      'Управляемые Skills с доступными обновлениями';

  @override
  String get libraryExternalScope => 'Внешние навыки';

  @override
  String get libraryEmptyAddProject => 'Перейти к добавлению проекта';
  ...
  @override
  String get localScanPermissionTitle => 'Прочитать эти папки';

  @override
  String get localScanPermissionDescription =>
      'Используется для определения установленных Skill и их использования.';

  @override
  String get localScanPrivacySummary =>
      'Обрабатывается только на этом устройстве. Файлы и разговоры никогда не загружаются.';

  @override
  String get localScanContinue => 'Продолжить';

  @override
  String get localScanDefer => 'Не сейчас';

  @override
  String get localScanDeferredTitle => 'Проекты ещё не прочитаны';

  @override
  String get localScanDeferredMessage =>
      'Разрешите доступ, чтобы определить установленные Skills и их использование.';

  @override
  String get localScanResume => 'Продолжить чтение';
