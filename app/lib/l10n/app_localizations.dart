...
abstract class AppLocalizations {
  ...
  /// No description provided for @privacySettingsOpenFailed.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @libraryNeedsAttention.
  ///
  /// In en, this message translates to:
  /// **'Needs Attention'**
  String get libraryNeedsAttention;

  /// No description provided for @libraryBudgetInsights.
  ///
  /// In en, this message translates to:
  /// **'Resident Skill budget insights'**
  String get libraryBudgetInsights;

  /// No description provided for @libraryResidentBudget.
  ///
  /// In en, this message translates to:
  /// **'Resident context'**
  String get libraryResidentBudget;

  /// No description provided for @libraryResidentBudgetTooltip.
  ///
  /// In en, this message translates to:
  /// **'Character count of Skill names and descriptions in the current scope. Search, status filters, and sorting do not affect it.'**
  String get libraryResidentBudgetTooltip;

  /// No description provided for @libraryUnusedBudget45Days.
  ///
  /// In en, this message translates to:
  /// **'Idle footprint'**
  String get libraryUnusedBudget45Days;

  /// No description provided for @libraryUnusedBudget45DaysTooltip.
  ///
  /// In en, this message translates to:
  /// **'Character count and share occupied by Skills with available usage data and zero calls in the last 45 days. Click to filter; ≥ means some usage data is unavailable.'**
  String get libraryUnusedBudget45DaysTooltip;

  /// No description provided for @libraryBudgetUnknown.
  ///
  /// In en, this message translates to:
  /// **'Unavailable'**
  String get libraryBudgetUnknown;

  /// No description provided for @libraryBudgetCharacters.
  ///
  /// In en, this message translates to:
  /// **'chars'**
  String get libraryBudgetCharacters;

  /// No description provided for @libraryFilterEmptyTitle.
  ///
  /// In en, this message translates to:
  /// **'No Skills match these filters'**
  String get libraryFilterEmptyTitle;

  /// No description provided for @libraryFilterEmptyMessage.
  ///
  /// In en, this message translates to:
  /// **'Clear or change a management or usage condition to see more Skills.'**
  String get libraryFilterEmptyMessage;

  /// No description provided for @libraryUnusedEmptyTitle.
  ///
  /// In en, this message translates to:
  /// **'No unused Skills'**
  String get libraryUnusedEmptyTitle;

  /// No description provided for @libraryUnusedEmptyMessage.
  ///
  /// In en, this message translates to:
  /// **'Every Skill with available usage data was called in the last 45 days.'**
  String get libraryUnusedEmptyMessage;

  /// No description provided for @libraryOtherEmptyTitle.
  ///
  /// In en, this message translates to:
  /// **'No other installations'**
  String get libraryOtherEmptyTitle;

  /// No description provided for @libraryOtherEmptyMessage.
  ///
  /// In en, this message translates to:
  /// **'Every Skill in this context is managed by SkillsGo.'**
  String get libraryOtherEmptyMessage;

  /// No description provided for @libraryUpdatesEmptyMessage.
  ///
  /// In en, this message translates to:
  /// **'No Package updates are available in this context.'**
  String get libraryUpdatesEmptyMessage;

  /// No description provided for @libraryUsageUnavailable.
  ///
  /// In en, this message translates to:
  /// **'Usage unavailable'**
  String get libraryUsageUnavailable;

  /// No description provided for @libraryUsageCalculating.
  ///
  /// In en, this message translates to:
  /// **'Counting'**
  String get libraryUsageCalculating;

  /// No description provided for @libraryUsageNotSupported.
  ///
  /// In en, this message translates to:
  /// **'Not supported yet'**
  String get libraryUsageNotSupported;

  /// No description provided for @libraryUsageContributionMessage.
  ///
  /// In en, this message translates to:
  /// **'SkillsGo is open source, but we cannot install and test every coding agent. Your coding agent can help us add usage support for {agents}.'**
  String libraryUsageContributionMessage(String agents);

  /// No description provided for @libraryUsageContributionPrompt.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @libraryUsageCopyContributionPrompt.
  ///
  /// In en, this message translates to:
  /// **'Copy prompt'**
  String get libraryUsageCopyContributionPrompt;

  /// No description provided for @libraryUsageContributionPromptCopied.
  ///
  /// In en, this message translates to:
  /// **'Copied'**
  String get libraryUsageContributionPromptCopied;

  /// No description provided for @libraryUsageOpenRepository.
  ///
  /// In en, this message translates to:
  /// **'Open GitHub'**
  String get libraryUsageOpenRepository;

  /// No description provided for @libraryUsageCount.
  ///
  /// In en, this message translates to:
  /// **'{count} calls'**
  String libraryUsageCount(int count);

  /// No description provided for @librarySortPackageGrouped.
  ///
  /// In en, this message translates to:
  /// **'Package grouped'**
  String get librarySortPackageGrouped;
  ...
  /// No description provided for @libraryUnused45Days.
  ///
  /// In en, this message translates to:
  /// **'Unused for 45 days'**
  String get libraryUnused45Days;

  /// No description provided for @libraryUnused90Days.
  ///
  /// In en, this message translates to:
  /// **'Unused for 90 days'**
  String get libraryUnused90Days;
  ...
  /// No description provided for @libraryManagementStatus.
  ///
  /// In en, this message translates to:
  /// **'Management status'**
  String get libraryManagementStatus;

  /// No description provided for @libraryUsageStatus.
  ///
  /// In en, this message translates to:
  /// **'Usage status'**
  String get libraryUsageStatus;

  /// No description provided for @libraryAnyUsage.
  ///
  /// In en, this message translates to:
  /// **'Any usage'**
  String get libraryAnyUsage;
  ...
  /// No description provided for @libraryFilterUnused45DaysTooltip.
  ///
  /// In en, this message translates to:
  /// **'Skills with available usage statistics and no calls in the last 45 days'**
  String get libraryFilterUnused45DaysTooltip;

  /// No description provided for @libraryFilterUnused90DaysTooltip.
  ///
  /// In en, this message translates to:
  /// **'Skills with available usage statistics and no calls in the last 90 days'**
  ...
  /// No description provided for @librarySkillColumn.
  ///
  /// In en, this message translates to:
  /// **'Skill'**
  String get librarySkillColumn;

  /// No description provided for @libraryHits45Days.
  ///
  /// In en, this message translates to:
  /// **'45d'**
  String get libraryHits45Days;

  /// No description provided for @libraryHits90Days.
  ///
  /// In en, this message translates to:
  /// **'90d'**
  String get libraryHits90Days;

  /// No description provided for @libraryInstallationColumn.
  ///
  /// In en, this message translates to:
  /// **'Installation'**
  String get libraryInstallationColumn;
  ...
  /// No description provided for @localScanPermissionTitle.
  ///
  /// In en, this message translates to:
  /// **'Read these folders'**
  String get localScanPermissionTitle;

  /// No description provided for @localScanPermissionDescription.
  ///
  /// In en, this message translates to:
  /// **'Used to identify installed Skills and usage.'**
  String get localScanPermissionDescription;

  /// No description provided for @localScanPrivacySummary.
  ///
  /// In en, this message translates to:
  /// **'Processed only on this device. Files and conversations are never uploaded.'**
  String get localScanPrivacySummary;

  /// No description provided for @localScanContinue.
  ///
  /// In en, this message translates to:
  /// **'Continue'**
  String get localScanContinue;

  /// No description provided for @localScanDefer.
  ///
  /// In en, this message translates to:
  /// **'Not now'**
  String get localScanDefer;

  /// No description provided for @localScanDeferredTitle.
  ///
  /// In en, this message translates to:
  /// **'Projects not read yet'**
  String get localScanDeferredTitle;

  /// No description provided for @localScanDeferredMessage.
  ///
  /// In en, this message translates to:
  /// **'Allow access to identify their installed Skills and usage.'**
  String get localScanDeferredMessage;

  /// No description provided for @localScanResume.
  ///
  /// In en, this message translates to:
  /// **'Continue reading'**
  String get localScanResume;
