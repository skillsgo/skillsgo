...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get libraryFilter => 'フィルター';
  ...
  String get privacySettingsOpenFailed =>
      'システム設定を開けませんでした。手動で開いてから、もう一度お試しください。';
  ...
  @override
  String get libraryNeedsAttention => '要対応';

  @override
  String get libraryBudgetInsights => '常駐 Skill 予算の概要';

  @override
  String get libraryResidentBudget => '常駐コンテキスト';

  @override
  String get libraryResidentBudgetTooltip =>
      '現在のスコープにある Skill 名と説明の文字数です。検索、フィルター、並べ替えの影響は受けません。';

  @override
  String get libraryUnusedBudget45Days => '未使用の占有量';

  @override
  String get libraryUnusedBudget45DaysTooltip =>
      '使用データが取得でき、過去 45 日間の呼び出しが 0 回の Skills が占める文字数と割合です。クリックすると絞り込めます。≥ は一部の使用データを取得できないことを示します。';

  @override
  String get libraryBudgetUnknown => '利用不可';

  @override
  String get libraryBudgetCharacters => '文字';

  @override
  String get libraryFilterEmptyTitle => 'これらのフィルターに一致する Skill はありません';

  @override
  String get libraryFilterEmptyMessage =>
      '管理または使用状況の条件を変更すると、ほかの Skill を表示できます。';

  @override
  String get libraryUnusedEmptyTitle => '未使用の Skill はありません';

  @override
  String get libraryUnusedEmptyMessage =>
      '使用データが取得できるすべての Skill は、過去45日以内に呼び出されています。';

  @override
  String get libraryOtherEmptyTitle => 'その他のインストールはありません';

  @override
  String get libraryOtherEmptyMessage =>
      'このコンテキストのすべての Skill は SkillsGo で管理されています。';

  @override
  String get libraryUpdatesEmptyMessage => 'このコンテキストで利用可能な Package 更新はありません。';

  @override
  String get libraryUsageUnavailable => '使用状況を取得できません';

  @override
  String get libraryUsageCalculating => '集計中';
  ...
  @override
  String get librarySortPackageGrouped => 'Package 別にグループ化';
  ...
  @override
  String get libraryImportedSkills => 'SkillsGo が管理';

  @override
  String get libraryLocalSkills => '別の方法でインストール';

  @override
  String get libraryUnused45Days => '45日間未使用';

  @override
  String get libraryUnused90Days => '90日間未使用';

  @override
  String get libraryFilterTooltip => 'この範囲のインストール済み Skills すべて';

  @override
  String get libraryManagementStatus => '管理状態';

  @override
  String get libraryUsageStatus => '使用状況';

  @override
  String get libraryAnyUsage => '使用状況を問わない';

  @override
  String get libraryFilterManagedTooltip => 'SkillsGo で更新・削除できます';

  @override
  String get libraryFilterOtherTooltip => '更新前にSkillsGoの管理に追加してください';

  @override
  String get libraryFilterUnused45DaysTooltip =>
      '利用統計が取得可能で、過去45日間に呼び出されていない Skills';

  @override
  String get libraryFilterUnused90DaysTooltip =>
      '利用統計が取得可能で、過去90日間に呼び出されていない Skills';

  @override
  String get libraryFilterUpdatesTooltip => '更新可能な管理対象 Skills';
  ...
  @override
  String get localScanPermissionTitle => 'これらのフォルダを読み取る';

  @override
  String get localScanPermissionDescription => 'インストール済み Skill と使用状況の確認に使用します。';

  @override
  String get localScanPrivacySummary => 'このデバイス内でのみ処理され、ファイルや会話はアップロードされません。';

  @override
  String get localScanContinue => '続ける';

  @override
  String get localScanDefer => '今はしない';

  @override
  String get localScanDeferredTitle => 'プロジェクトはまだ読み取られていません';

  @override
  String get localScanDeferredMessage =>
      'インストール済みの Skill と使用状況を確認するにはアクセスを許可してください。';

  @override
  String get localScanResume => '読み取りを続ける';
  ...
  String installPackageSkills(String packagePath, int count) {
    return 'すべての $packagePath スキル ($count) をインストールします';
  }
  ...
  @override
  String get batchAdoptionAction => '既存のスキルを管理する';
  ...
  @override
  String get batchAdoptionChecking => '既存のスキルを確認しています…';

  @override
  String get batchAdoptionRetry => '管理に追加できるスキルを再確認';
  ...
  @override
  String get batchAdoptionPending => 'マネジメントにスキルを加える…';

  @override
  String get batchAdoptionTitle => 'SkillsGo で既存のスキルを管理しますか?';
  ...
  @override
  String get batchAdoptionPainLocation => '不明なインストール場所';

  @override
  String get batchAdoptionPainFreshness => '不明なアップデートステータス';

  @override
  String get batchAdoptionPainRecovery => '壊れたら回復しない';

  @override
  String get batchAdoptionPainVersionDrift => 'プロジェクト間で異なるバージョン';

  @override
  String get batchAdoptionFolderTitle => '既存のスキル';

  @override
  String get batchAdoptionFolderSubtitle => '不明なステータス';

  @override
  String get batchAdoptionAfterLabel => '後';

  @override
  String get batchAdoptionAfterTitle => 'クリアライブラリー 1 つ';

  @override
  String get batchAdoptionLibraryTitle => 'SkillsGo ライブラリ';

  @override
  String get batchAdoptionBenefitLocation => '場所をクリアする';

  @override
  String get batchAdoptionBenefitFreshness => '更新が表示されます';

  @override
  String get batchAdoptionBenefitRecovery => '簡単な回復';

  @override
  String get batchAdoptionBenefitVersions => 'バージョンクリア';

  @override
  String get batchAdoptionManagedSection => 'SkillsGo が管理';

  @override
  String get batchAdoptionPendingSection => '保留中';
  ...
  @override
  String get batchAdoptionTransitionLabel => '整理する';

  @override
  String get batchAdoptionStatusTitle => '管理状況';

  @override
  String get batchAdoptionStatusManaged => '管理された';

  @override
  String get batchAdoptionStatusProgress => '整理する';

  @override
  String get batchAdoptionStatusSkipped => 'スキップされました';

  @override
  String get batchAdoptionStatusFilesStay => 'スキルファイルは元の場所に残ります';
  ...
  @override
  String get batchAdoptionBoardComplete => 'オールクリア';

  @override
  String get batchAdoptionBoardPartial => '完了';

  @override
  String get batchAdoptionStatusTotal => '合計';

  @override
  String get batchAdoptionQueueComplete => '待っているスキルはありません';

  @override
  String get batchAdoptionQueueWaiting => 'スキルは検証後にここに移動します';

  @override
  String get batchAdoptionNextLabel => '次へ';
  ...
  @override
  String get batchAdoptionSkip => '今ではありません';

  @override
  String get batchAdoptionConfirm => '管理に追加';

  @override
  String get batchAdoptionExecutionRetry => '再試行';

  @override
  String get batchAdoptionResultTitle => 'マネジメントにスキルを追加';

  @override
  String batchAdoptionSummary(int adopted, int skipped) {
    return '$adopted スキルが管理に追加され、$skipped はスキップされました。';
  }
  ...
  @override
  String get batchAdoptionClose => '閉じる';

  @override
  String get installMoreTargets => 'より多くの場所にインストールする';

  @override
  String get detailPackageSource => 'パッケージの提供元';
