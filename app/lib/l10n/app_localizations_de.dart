...
class AppLocalizationsDe extends AppLocalizations {
  ...
  @override
  String get libraryFilter => 'Filtern';
  ...
  String get appUpdateDescription =>
      'Im Release-Feed nach einer neueren SkillsGo-Version suchen.';

  @override
  String get appUpdateNotConfigured =>
      'App-Updates sind in diesem Build nicht verfügbar.';

  @override
  String get appUpdateReady =>
      'Prüfen Sie, wenn Sie bereit sind. SkillsGo installiert kein Update ohne Ihre Aktion.';

  @override
  String get appUpdateChecking => 'App-Update wird gesucht…';

  @override
  String get appUpdateApplying =>
      'Update wird heruntergeladen. SkillsGo startet neu, sobald es bereit ist.';

  @override
  String get appUpdateCheckFailed =>
      'SkillsGo konnte nicht nach einem App-Update suchen. Prüfen Sie Ihre Verbindung und versuchen Sie es erneut.';

  @override
  String appUpdateAvailable(String version) {
    return 'SkillsGo $version ist verfügbar.';
  }

  @override
  String appUpdateCurrent(String version) {
    return 'SkillsGo $version ist aktuell.';
  }

  @override
  String get appUpdateCheckAction => 'Nach App-Updates suchen';

  @override
  String get appUpdateApplyAction => 'Aktualisieren und neu starten';
  ...
  String get privacySettingsOpenFailed =>
      'Die Systemeinstellungen konnten nicht geöffnet werden. Öffnen Sie sie manuell und versuchen Sie es erneut.';
  ...
  String get packageSkillsSwitchTogether =>
      'Fertigkeiten aus diesem Paket wechseln gemeinsam die Version.';
  ...
  String upgradeToVersion(String version) {
    return 'Upgrade auf $version';
  }

  @override
  String downgradeToVersion(String version) {
    return 'Downgrade auf $version';
  }
  ...
  @override
  String get libraryNeedsAttention => 'Aufmerksamkeit erforderlich';

  @override
  String get libraryBudgetInsights => 'Übersicht zum residenten Skill-Budget';

  @override
  String get libraryResidentBudget => 'Residenter Kontext';

  @override
  String get libraryResidentBudgetTooltip =>
      'Zeichenanzahl der Skill-Namen und -Beschreibungen im aktuellen Bereich. Suche, Filter und Sortierung beeinflussen diesen Wert nicht.';

  @override
  String get libraryUnusedBudget45Days => 'Ungenutzter Anteil';

  @override
  String get libraryUnusedBudget45DaysTooltip =>
      'Zeichenanzahl und Anteil von Skills mit verfügbaren Nutzungsdaten und null Aufrufen in den letzten 45 Tagen. Zum Filtern klicken; ≥ bedeutet, dass Nutzungsdaten teilweise fehlen.';

  @override
  String get libraryBudgetUnknown => 'Nicht verfügbar';

  @override
  String get libraryBudgetCharacters => 'Zeichen';

  @override
  String get libraryFilterEmptyTitle =>
      'Keine Skills entsprechen diesen Filtern';

  @override
  String get libraryFilterEmptyMessage =>
      'Ändern Sie eine Verwaltungs- oder Nutzungsbedingung, um weitere Skills anzuzeigen.';

  @override
  String get libraryUnusedEmptyTitle => 'Keine ungenutzten Skills';

  @override
  String get libraryUnusedEmptyMessage =>
      'Jeder Skill mit verfügbaren Nutzungsdaten wurde in den letzten 45 Tagen aufgerufen.';

  @override
  String get libraryOtherEmptyTitle => 'Keine anderen Installationen';

  @override
  String get libraryOtherEmptyMessage =>
      'Jeder Skill in diesem Kontext wird von SkillsGo verwaltet.';

  @override
  String get libraryUpdatesEmptyMessage =>
      'In diesem Kontext sind keine Package-Updates verfügbar.';

  @override
  String get libraryUsageUnavailable => 'Nutzungsdaten nicht verfügbar';

  @override
  String get libraryUsageCalculating => 'Wird gezählt';
  ...
  @override
  String get librarySortPackageGrouped => 'Nach Package gruppiert';
  ...
  @override
  String get libraryGlobalScope => 'Globale Fähigkeiten';

  @override
  String get libraryImportedSkills => 'Von SkillsGo verwaltet';

  @override
  String get libraryLocalSkills => 'Anders installiert';

  @override
  String get libraryUnused45Days => 'Seit 45 Tagen nicht verwendet';

  @override
  String get libraryUnused90Days => 'Seit 90 Tagen nicht verwendet';

  @override
  String get libraryFilterTooltip =>
      'Alle installierten Skills in diesem Bereich';

  @override
  String get libraryManagementStatus => 'Verwaltungsstatus';

  @override
  String get libraryUsageStatus => 'Nutzungsstatus';

  @override
  String get libraryAnyUsage => 'Beliebige Nutzung';

  @override
  String get libraryFilterManagedTooltip =>
      'Von SkillsGo aktualisier- und löschbar';

  @override
  String get libraryFilterOtherTooltip =>
      'Vor dem Aktualisieren zuerst von SkillsGo verwalten lassen';

  @override
  String get libraryFilterUnused45DaysTooltip =>
      'Skills mit verfügbaren Nutzungsstatistiken und ohne Aufrufe in den letzten 45 Tagen';

  @override
  String get libraryFilterUnused90DaysTooltip =>
      'Skills mit verfügbaren Nutzungsstatistiken und ohne Aufrufe in den letzten 90 Tagen';

  @override
  String get libraryFilterUpdatesTooltip =>
      'Verwaltete Skills mit verfügbaren Updates';

  @override
  String get libraryExternalScope => 'Externe Fähigkeiten';

  @override
  String get libraryEmptyAddProject => 'Zu „Projekt hinzufügen“';

  @override
  String get globalScope => 'Global';

  @override
  String get globalSkills => 'Globale Fähigkeiten';
  ...
  String get projectMissingMessage =>
      'Möglicherweise wurde das Verzeichnis verschoben oder sein Volume ist offline. Überprüfen Sie den Pfad oder entfernen Sie die App-Referenz.';
  ...
  String get projectPermissionMessage =>
      'SkillsGo kann dieses Projektstammverzeichnis nicht überprüfen. Überprüfen Sie die Dateisystemberechtigungen oder entfernen Sie die App-Referenz.';
  ...
  String get projectInaccessibleMessage =>
      'SkillsGo hat diese Projektreferenz beibehalten. Überprüfen Sie den Pfad oder das Volume oder entfernen Sie dessen App-Referenz.';
  ...
  String cloudHttpFailure(int status) {
    return 'Cloud hat HTTP $status zurückgegeben. Überprüfen Sie die Ursprungs- und Dienstkonfiguration.';
  }

  @override
  String get cloudInvalidProtocol =>
      'Der Server hat das Cloud-Ranking-Protokoll SkillsGo nicht zurückgegeben.';

  @override
  String get cloudInvalidJson => 'Cloud hat den ungültigen JSON zurückgegeben.';

  @override
  String get cloudConnectionFailure =>
      'Cloud konnte nicht erreicht werden. Überprüfen Sie die Konfiguration von Ursprung, Netzwerk, Proxy und TLS.';

  @override
  String get cloudConnectionTimeout =>
      'Bei der Cloud-Verbindung ist eine Zeitüberschreitung aufgetreten. Überprüfen Sie das Netzwerk oder versuchen Sie es erneut.';
  ...
  String get privacySummary =>
      'Suchtext und Skill-Inhalte werden nicht protokolliert. Bereinigte lokale Diagnosen werden bis zu 7 Tage lang gespeichert und nie automatisch hochgeladen.';

  @override
  String get localScanPermissionTitle => 'Diese Ordner lesen';

  @override
  String get localScanPermissionDescription =>
      'Dient zum Erkennen installierter Skills und ihrer Nutzung.';

  @override
  String get localScanPrivacySummary =>
      'Wird nur auf diesem Gerät verarbeitet. Dateien und Unterhaltungen werden nie hochgeladen.';

  @override
  String get localScanContinue => 'Weiter';

  @override
  String get localScanDefer => 'Nicht jetzt';

  @override
  String get localScanDeferredTitle => 'Projekte noch nicht gelesen';

  @override
  String get localScanDeferredMessage =>
      'Erlaube den Zugriff, um installierte Skills und ihre Nutzung zu erkennen.';

  @override
  String get localScanResume => 'Weiterlesen';
  ...
  String diagnosticLogsDescription(String size) {
    return 'Lokale App und CLI-Diagnose verwenden $size. Protokolle rotieren automatisch, werden bis zu 7 Tage lang aufbewahrt und nie automatisch hochgeladen.';
  }

  @override
  String get openLogFolder => 'Ordner öffnen';

  @override
  String get viewLiveLogs => 'Live ansehen';
  ...
  @override
  String get logsExported => 'Diagnoseprotokolle exportiert.';

  @override
  String get logsCleared => 'Diagnoseprotokolle gelöscht.';

  @override
  String get logActionFailed =>
      'Die Diagnoseprotokollaktion konnte nicht abgeschlossen werden.';

  @override
  String get logViewerLive => 'Live';

  @override
  String get logViewerPaused => 'Angehalten';
  ...
  @override
  String get warningLogs => 'Warnungen';

  @override
  String get errorLogs => 'Fehler';

  @override
  String get pauseLogFollow => 'Pause';

  @override
  String get resumeLogFollow => 'Wieder aufnehmen';

  @override
  String get clearViewer => 'Klare Sicht';

  @override
  String get noDiagnosticLogs => 'Noch keine passenden Protokolle.';

  @override
  String get backToLatestLog => 'Letzte';
  ...
  @override
  String get translatedContent => 'Übersetzt';
  ...
  @override
  String get showOriginalContent => 'Original anzeigen';
  ...
  String handExternalSkillsToSkillsGoManagementCount(int count) {
    return 'Lassen Sie SkillsGo die externen Fähigkeiten von $count verwalten';
  }

  @override
  String confirmSkillsGoManagementCount(int selected, int total) {
    return 'Bestätigen Sie die SkillsGo-Verwaltung ($selected/$total)';
  }

  @override
  String get skillColumnLabel => 'Fähigkeit';

  @override
  String get packageSourceColumnLabel => 'Quelle';

  @override
  String get versionColumnLabel => 'Version';

  @override
  String get packageMatching => 'Passende Quellen…';

  @override
  String get sourceMatchUnavailable => 'Quellenabgleich nicht verfügbar';

  @override
  String get noSourceMatches => 'Keine passende Quelle';
  ...
  @override
  String get versionPendingSelection => 'Wählen Sie zunächst eine Quelle aus';
  ...
  String batchAdoptionFailureSummary(int adopted, int failed) {
    return '$adopted Fähigkeiten zur Verwaltung hinzugefügt, $failed fehlgeschlagen.';
  }

  @override
  String get batchAdoptionStatusFailed => 'Fehlgeschlagen';
  ...
  String get removeSkillsDescription =>
      'Die folgenden Fähigkeiten werden entfernt';

  @override
  String confirmRemoveSkillsInline(int count) {
    return '$count-Fähigkeiten entfernen?';
  }

  @override
  String removingSkillsProgress(int finished, int total) {
    return 'Entfernen von $finished/$total';
  }

  @override
  String get confirmRemoveSkillsAction => 'Jetzt entfernen';

  @override
  String get viewRemovalDetails => 'Details anzeigen';

  @override
  String get hideRemovalDetails => 'Details ausblenden';
