...
class AppLocalizationsVi extends AppLocalizations {
  ...
  @override
  String get libraryFilter => 'Bộ lọc';
  ...
  String get privacySettingsOpenFailed =>
      'Không thể mở Cài đặt hệ thống. Hãy mở thủ công rồi thử lại.';
  ...
  @override
  String get libraryNeedsAttention => 'Cần chú ý';

  @override
  String get libraryBudgetInsights => 'Tổng quan ngân sách Skill thường trú';

  @override
  String get libraryResidentBudget => 'Ngữ cảnh thường trú';

  @override
  String get libraryResidentBudgetTooltip =>
      'Số ký tự trong tên và mô tả Skill thuộc phạm vi hiện tại. Tìm kiếm, bộ lọc và sắp xếp không ảnh hưởng đến giá trị này.';

  @override
  String get libraryUnusedBudget45Days => 'Dung lượng nhàn rỗi';

  @override
  String get libraryUnusedBudget45DaysTooltip =>
      'Số lượng và tỷ lệ ký tự của Skills có dữ liệu sử dụng và không được gọi trong 45 ngày qua. Nhấp để lọc; ≥ nghĩa là thiếu một phần dữ liệu sử dụng.';

  @override
  String get libraryBudgetUnknown => 'Không khả dụng';

  @override
  String get libraryBudgetCharacters => 'ký tự';

  @override
  String get libraryFilterEmptyTitle =>
      'Không có Skill nào khớp với các bộ lọc này';

  @override
  String get libraryFilterEmptyMessage =>
      'Thay đổi điều kiện quản lý hoặc sử dụng để xem thêm Skill.';

  @override
  String get libraryUnusedEmptyTitle => 'Không có Skill chưa dùng';

  @override
  String get libraryUnusedEmptyMessage =>
      'Mọi Skill có dữ liệu sử dụng đều đã được gọi trong 45 ngày qua.';

  @override
  String get libraryOtherEmptyTitle => 'Không có bản cài đặt khác';

  @override
  String get libraryOtherEmptyMessage =>
      'Mọi Skill trong ngữ cảnh này đều do SkillsGo quản lý.';

  @override
  String get libraryUpdatesEmptyMessage =>
      'Không có bản cập nhật Package trong ngữ cảnh này.';

  @override
  String get libraryUsageUnavailable => 'Không có dữ liệu sử dụng';

  @override
  String get libraryUsageCalculating => 'Đang đếm';
  ...
  String libraryUsageCount(int count) {
    return '$count lượt gọi';
  }

  @override
  String get librarySortPackageGrouped => 'Nhóm theo Package';

  @override
  String get librarySortDescending => 'Giảm dần';

  @override
  String get librarySortAscending => 'Tăng dần';
  ...
  @override
  String get libraryUnused45Days => 'Không dùng trong 45 ngày';

  @override
  String get libraryUnused90Days => 'Không dùng trong 90 ngày';
  ...
  @override
  String get libraryManagementStatus => 'Trạng thái quản lý';

  @override
  String get libraryUsageStatus => 'Trạng thái sử dụng';

  @override
  String get libraryAnyUsage => 'Mọi mức sử dụng';
  ...
  String get libraryFilterUnused45DaysTooltip =>
      'Skills có thống kê khả dụng và không được gọi trong 45 ngày qua';

  @override
  String get libraryFilterUnused90DaysTooltip =>
      'Skills có thống kê khả dụng và không được gọi trong 90 ngày qua';
  ...
  @override
  String get localScanPermissionTitle => 'Đọc các thư mục này';

  @override
  String get localScanPermissionDescription =>
      'Dùng để nhận diện Skill đã cài đặt và mức sử dụng.';

  @override
  String get localScanPrivacySummary =>
      'Chỉ xử lý trên thiết bị này. Tệp và cuộc trò chuyện không bao giờ được tải lên.';

  @override
  String get localScanContinue => 'Tiếp tục';

  @override
  String get localScanDefer => 'Để sau';

  @override
  String get localScanDeferredTitle => 'Chưa đọc các dự án';

  @override
  String get localScanDeferredMessage =>
      'Cho phép truy cập để nhận diện các Skill đã cài đặt và mức sử dụng.';

  @override
  String get localScanResume => 'Tiếp tục đọc';
