/*
 * [INPUT]: Depends on the app_shell library for gateway contracts, HugeIcons, Riverpod installation and Package update-check operations, localized UI components, and shared navigation callbacks.
 * [OUTPUT]: Provides remote Skill detail with manual Package update checking plus direct confirmed Installation, installed-Package Update, managed member removal, risk, progress, result, and retry flows without a second target matrix.
