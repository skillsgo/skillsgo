/*
 * [INPUT]: Depends on Library selection identity, selected entries, removal callbacks, motion preferences, and installed-source identity.
 * [OUTPUT]: Provides scope grouping, a removal-only stable selection bar, source labels, toolbar motion, and the Project-add rail action.
 * [POS]: Serves as the multi-selection, scope-control, and Project rail-action segment of the unified Library journey.
