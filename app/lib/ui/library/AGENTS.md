...
- `library_actions.dart`: coordinates refresh, project, plan-authorized adoption, direct Package update followed by inventory and App-scoped update-cache refresh, and exact removal actions.
