/*
 * [INPUT]: Depends on Flutter display constraints and caller-selected responsive breakpoints.
 * [OUTPUT]: Provides Mermaid responsive thresholds and derived device-specific spacing, typography, and sizing values.
 * [POS]: Serves as the shared responsive configuration boundary for native Mermaid widgets, layouts, and painters.
