...
- `app_shell.dart`: renders the desktop shell and stateful Search, Ranking, Trending, Hot, Agent-aware Library/auditable detail, operation, and Settings journeys.
