...
- `app_shell.dart`: renders the desktop shell and stateful Search, Ranking, Trending, Hot, searchable managed/external multi-target Library/auditable detail, read-only External inspection, explicit-project and Agent views, operation, and Settings journeys.
