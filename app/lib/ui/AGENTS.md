...
- `app_shell.dart`: renders the desktop shell and stateful Discover collections, explicit shadcn_ui Installation, Update, Target Management, and External Adoption flows with exact-target selection, progress, offline recovery alerts, and results; searchable Registry/Local/External multi-target Library/detail that survives Registry outages; Local export; project and Agent views; operations; and Settings journeys.
