...
- `app_shell.dart`: renders the desktop shell and stateful Discover collections, explicit shadcn_ui Installation, Update, Target Management, and External Adoption flows with exact-target selection, progress, recovery actions, and results; searchable Registry/Local/External multi-target Library/detail; Local export; project and Agent views; operations; and Settings journeys.
