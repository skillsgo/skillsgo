...
- `app_shell.dart`: renders the desktop shell and stateful Discover collections, explicit shadcn_ui Installation Plan matrix/preflight/results, searchable managed/external multi-target Library/detail, project and Agent views, operations, and Settings journeys.
