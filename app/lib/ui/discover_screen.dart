/*
 * [INPUT]: Depends on the app_shell library for Flutter UI primitives, Riverpod Discover state, installation flows, localization, and shared Package components.
 * [OUTPUT]: Provides the Discover destination, route-local desktop pull-to-refresh and automatic pagination behavior, catalog search, full-surface Package cards, in-tab Package and Skill detail transitions, and installation entry points.
