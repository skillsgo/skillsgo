...
class _DiscoverScreenState extends ConsumerState<DiscoverScreen>
  ...
  _SelectedPackageDetail? selectedPackage;
  ...
  void dismissDetail() {
    if (selectedSkill == null && selectedPackage == null) return;
  ...
  Widget build(BuildContext context) {
    ...
    final hasDetail = selectedSkill != null || selectedPackage != null;
    return Shortcuts(
      shortcuts: {
      ...
      child: Actions(
        ...
        child: SkillsContentFrame(
          child: Stack(
            ...
            children: [
              Offstage(
                offstage: hasDetail && !detailTransitioning,
                child: IgnorePointer(
                  ignoring: hasDetail,
                  child: ExcludeFocus(
                    excluding: hasDetail,
                    ...
                    child: ColoredBox(
                      ...
                      child: selectedPackage != null
                          ? PackageDetailScreen(
                              ...
                              onBack: _closePackageDetail,
                              onInstallAll: (presenter, anchorSkill) =>
                                  _installFromCard(
                                    presenter,
                                    anchorSkill,
                                    preferredAction:
                                        InstallLocationAction.moduleSkills,
                                  ),
                            )
                          : RemoteDetailScreen(
                              key: ValueKey(
                              ...
                              onOpenPackage: (packagePath, version) =>
                                  _openPackageDetail(
...
class _SelectedPackageDetail {
  const _SelectedPackageDetail({
