/*
 * [INPUT]: Depends on DiscoverScreen state, localized failure copy, shared Package summary cards, and Skill card/installation widgets.
 * [OUTPUT]: Provides search and collection loading, empty, refresh, pagination, full-card Package context, and Skill-detail transition render methods.
    ...
    child: Semantics(
      ...
      child: Container(
        ...
        child: PackageSummaryCard(
          ...
          skills: skills,
          summary: module,
          onOpen: () => _openPackageDetail(
            packagePath: source,
            version: module?.latestVersion ?? skills.first.latestVersion,
            summary: module,
          ),
          onUpdated: () {
            final routeState = ref
