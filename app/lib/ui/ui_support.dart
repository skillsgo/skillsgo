/*
 * [INPUT]: Depends on App domain and Package update-operation status contracts, localized copy, SkillsGo design tokens, HugeIcons, and native Material components.
 * [OUTPUT]: Provides localized BuildContext access, shared failure, Hub/Cloud, and Package update status copy, command result rendering, stable Library target keys, Agent labels, and health/status presentation.
...
String packageUpdateOperationLabel(
  BuildContext context,
  PackageUpdateOperationState state,
) => switch (state.phase) {
  PackageUpdateOperationPhase.idle => context.l10n.checkUpdates,
  PackageUpdateOperationPhase.checking => context.l10n.checking,
  PackageUpdateOperationPhase.upToDate => context.l10n.upToDate,
  PackageUpdateOperationPhase.updating =>
    Localizations.localeOf(context).languageCode == 'zh'
        ? '正在准备新版…'
        : 'Preparing update…',
  PackageUpdateOperationPhase.updated =>
    Localizations.localeOf(context).languageCode == 'zh' ? '完成' : 'Done',
  PackageUpdateOperationPhase.failed => context.l10n.retry,
};
