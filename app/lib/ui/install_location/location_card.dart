/*
 * [INPUT]: Depends on Agent catalogs, Added Projects, exact existing targets, project icon resolution, install actions, target selections, submission state, and feedback.
 * [OUTPUT]: Provides the stateful location, project, Agent, Package-action loading gate, uniform reinstall-capable target selection, validation, and a stably identified Install action with immediate busy feedback.
