 ...
 * [OUTPUT]: Provides shared status enums including the atomic local-scan notice decision, update availability and its persisted App cache, App preferences, local diagnostic-log metadata and live entries, typed CLI process/transport contracts, command results, and typed Skills failures.
...
enum LocalScanNoticeDecision { unseen, deferred, accepted }
