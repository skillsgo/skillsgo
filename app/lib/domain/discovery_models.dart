 ...
 * [OUTPUT]: Provides discovery summaries with local-version install actions, canonical pagination, ordered Package-scoped candidate queries carrying local descriptions for server ranking, canonical coordinate identity and exact Package member paths, Package metadata and detail with source-pinned README presentation, user-triggered Package update-check results, pages, and auditable files.
...
enum PackageUpdateCheckStatus { upToDate, updating }
...
class PackageUpdateCheckResult {
  ...
  final String packagePath;
  final PackageUpdateCheckStatus status;
  final String version;
}
