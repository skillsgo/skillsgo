...
- `real_skills_gateway_preferences.dart`: owns App preferences, Mandatory Onboarding state, CLI user-config project adaptation, Hub origin and `hub info` runtime discovery, risk policy, and App-version lookup.
