...
- `real_skills_gateway_preferences.dart`: owns App preferences, Mandatory Onboarding state, CLI Managed Scope registry adaptation, Hub origin and `hub info` runtime discovery, risk policy, and App-version lookup.
